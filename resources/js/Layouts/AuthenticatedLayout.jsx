    ...
    return (
        ...
        <SidebarProvider>
            ...
            <SidebarInset>
                <header className="flex h-16 shrink-0 items-center border-b px-4">
                    ...
                    <div className="flex items-center ml-auto space-x-4">
                        <div className="relative">
                            <button
                                type="button"
                                className="flex items-center space-x-2 rounded-full bg-white p-2 text-gray-500 hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 focus:ring-offset-gray-100"
                                id="user-menu-button"
                                aria-expanded="false"
                                aria-haspopup="true"
                ...
                <div className="h-full min-w-100 bg-gray-100 dark:bg-gray-900 px-2">
                    {children}
                    <Toaster />
                </div>
            </SidebarInset>
