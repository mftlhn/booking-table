...
const Index = ({ ...props }) => {
    const { search, setSearch, filteredData } = useSearch(props.users, ['name', 'email', 'role']);
                            ...
                            <TableBody>
                                {
                                    paginatedData.map((menu, index) => (
                                        <TableRow key={menu.id}>
                                            ...
                                            <TableCell>{menu.email}</TableCell>
                                            <TableCell>{menu?.roles?.map(role => role.name).join(', ')}</TableCell>
                                            <TableCell>
                                                {/* <EditMenu menu={menu} /> */}
